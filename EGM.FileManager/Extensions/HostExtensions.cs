...
namespace EGM.FileManager.Extensions
{
    /// <summary>
    /// Extensions to emulate a typical "Startup.cs" pattern for <see cref="IHostBuilder"/>
    /// </summary>
    // Taken from https://stackoverflow.com/a/63603562
            ...
            this IHostBuilder hostBuilder) where TStartup : class
        {
            ...
            hostBuilder.ConfigureServices((ctx, serviceCollection) =>
            {
                ...
                var startUpObj = hasConfigCtor ?
                    Activator.CreateInstance(typeof(TStartup), ctx.Configuration) as TStartup :
